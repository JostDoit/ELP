...
var $author$project$Main$GotWordsList = function (a) {
	return {$: 'GotWordsList', a: a};
};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Main$initModel, $author$project$Main$getWordsList);
};
...
var $author$project$Main$viewDefinitions = function (definitions) {
	return A2(
		$elm$core$List$map,
		function (definition) {
			return A2(
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('diff-choice')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('diff-btn-group')
											]),
										_List_fromArray(
											[
												A2(
